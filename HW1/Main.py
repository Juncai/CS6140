...
def main(config_path):
    ...
    if match:
        ...
        for i in range(k):
            ...
            training_errs.append(model.test(tr_data[0], tr_data[1], Utilities.mse))
            testing_errs.append(model.test(te_data[0], te_data[1], Utilities.mse))
        ...
        training_err = model.test(training_data[0], training_data[1], Utilities.mse)
        testing_err = model.test(testing_data[0], testing_data[1], Utilities.mse)
